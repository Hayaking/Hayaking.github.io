import{_ as n,V as s,W as a,a0 as e}from"./framework.1bd1ad73.js";const t={},p=e(`<h2 id="k8s-yaml" tabindex="-1"><a class="header-anchor" href="#k8s-yaml" aria-hidden="true">#</a> k8s yaml</h2><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">apiVersion</span><span class="token punctuation">:</span> v1
