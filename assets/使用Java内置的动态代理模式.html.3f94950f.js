import{_ as n,V as a,W as s,X as e}from"./framework.7aad78ec.js";const t={},o=e(`<h2 id="一、什么是动态代理" tabindex="-1"><a class="header-anchor" href="#一、什么是动态代理" aria-hidden="true">#</a> 一、什么是动态代理</h2><p>利用反射机制生成一个实现代理接口的匿名类，在调用具体方法前调用InvokeHandler来处理。即动态的生成静态代理</p><h2 id="二、java提供的动态代理" tabindex="-1"><a class="header-anchor" href="#二、java提供的动态代理" aria-hidden="true">#</a> 二、Java提供的动态代理</h2><p>InvocationHandler:</p><pre><code>java.lang.reflect
