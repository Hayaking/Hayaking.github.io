import{_ as n,V as s,W as a,X as e}from"./framework.44074f5b.js";const i={},o=e(`<h2 id="golang项目" tabindex="-1"><a class="header-anchor" href="#golang项目" aria-hidden="true">#</a> golang项目</h2><p>先复制go.mod/sum, 然后安装依赖，一般依赖不会怎么变化，让其在最底层，可以利用docker的缓存，只要依赖不变，每次打镜像的时候就不用重新下载依赖</p><div class="language-docker line-numbers-mode" data-ext="docker"><pre class="language-docker"><code><span class="token instruction"><span class="token keyword">FROM</span> golang:1.17.5-alpine3.15 <span class="token keyword">as</span> build</span>
